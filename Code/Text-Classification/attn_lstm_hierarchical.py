...
# load data
x_train, y_train = load_data("Data\\CSV\\train_small.csv", sample_ratio=1)
x_test, y_test = load_data("Data\\CSV\\test_small.csv", sample_ratio=1)

x_train, y_train = load_data("Data\\dbpedia_csv\\train.csv", sample_ratio=1)
x_test, y_test = load_data("Data\\dbpedia_csv\\test.csv", sample_ratio=1)
